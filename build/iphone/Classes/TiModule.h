...
/**
 The base class for all FFXIVAssistant modules
 */
...
/**
 FFXIVAssistant Platform calls this method on startup.
 */
-(void)startup;

/**
 FFXIVAssistant Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 FFXIVAssistant Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 FFXIVAssistant Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 FFXIVAssistant Platform calls this method on resume.
 @param sender The sender of the event.
 */
