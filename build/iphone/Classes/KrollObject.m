...
//@interface FFXIVAssistantObject : NSObject
//@end

@interface FFXIVAssistantObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FFXIVAssistantObject class]])
		{
			for (NSString *key in [[(FFXIVAssistantObject*)o modules] allKeys])
			{
