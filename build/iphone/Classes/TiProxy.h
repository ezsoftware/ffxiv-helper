...
//Rare exceptions to indicate a bug in the _ffxivassistant code (Eg, function that a subclass should have implemented)
...
/**
 The base class for FFXIVAssistant proxies.
 */
