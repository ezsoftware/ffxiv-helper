...
// in simulator we redefine to format for FFXIVAssistant Developer console
...
{\
	NSString * exceptionName = [@"org.ffxivassistant." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ffxivassistant";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFFXIVAssistantNativeItemNone = -1, 
	UIFFXIVAssistantNativeItemSpinner = -2,
	UIFFXIVAssistantNativeItemProgressBar = -3,
	
	UIFFXIVAssistantNativeItemSlider = -4,
	UIFFXIVAssistantNativeItemSwitch = -5,
	UIFFXIVAssistantNativeItemMultiButton = -6,
	UIFFXIVAssistantNativeItemSegmented = -7,
	
	UIFFXIVAssistantNativeItemTextView = -8,
	UIFFXIVAssistantNativeItemTextField = -9,
	UIFFXIVAssistantNativeItemSearchBar = -10,
	
	UIFFXIVAssistantNativeItemPicker = -11,
	UIFFXIVAssistantNativeItemDatePicker = -12,
	
	UIFFXIVAssistantNativeItemInfoLight = -13,
	UIFFXIVAssistantNativeItemInfoDark = -14,
	
	UIFFXIVAssistantNativeItemDisclosure = -15,
	
	UIFFXIVAssistantNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all FFXIVAssistant instances of
