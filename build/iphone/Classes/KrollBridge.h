...
@interface FFXIVAssistantObject : KrollCoverageObject {
#else
@interface FFXIVAssistantObject : KrollObject {
#endif
@private
...
extern NSString * FFXIVAssistant$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	FFXIVAssistantObject *_ffxivassistant;
    KrollObject* console;
	BOOL shutdown;
