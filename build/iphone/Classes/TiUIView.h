...
/**
 Base class for all FFXIVAssistant views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the FFXIVAssistant view hierarchy (such as wrapped iOS UIViews) was touched.
